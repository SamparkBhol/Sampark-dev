...
const ContactLinks = () => {
  const links = [
    ...
    { href: "https://linkedin.com/in/samparkbhol", icon: Linkedin, label: "LinkedIn", style: "bg-blue-600/20 hover:bg-blue-500/30 text-blue-300 border-blue-500/50" },
    { href: "mailto:sampark.bhol@example.com", icon: Mail, label: "Email", style: "bg-red-600/20 hover:bg-red-500/30 text-red-300 border-red-500/50" },
  ];
